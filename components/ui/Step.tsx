...
export default function Step({ num, title, description, isLast = false }: StepProps) {
  return (
    <div className="relative flex-1 min-w-[200px] text-center px-5">
      {!isLast && (
        <span className="absolute right-[-12px] top-7 text-[22px] text-wire font-light hidden sm:block">→</span>
      )}
